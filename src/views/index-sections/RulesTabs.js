                ...
                <CardBody>
                  ...
                  >
                    <TabPane tabId='iconPills1'>
                      <h6 className='text-center'>Lo que está <span className='text-danger'>PROHIBIDO</span> en el servidor</h6>
                      <List className='text-danger pl-3'>
                        <li>Vender rangos, objetos, o cualquier cosa del servidor por dinero real u otro medio externo a TerraKraft</li><hr color='red' />
                        <li>Proteger terrenos donde no deseas construir o a menos de 50 bloques de otro jugador</li><hr color='red' />
                    ...
                    <TabPane tabId='iconPills2'>
                      <h6 className='text-center'>Lo que está  <span className='text-success'>permitido</span> en el servidor</h6>
                      <List className='text-success pl-3'>
                        <li>Software de terceros: Optifine, Badlion y Lunar Client.<br />Si crees que algún otro mod/software de tercero debería estar permitido, sugiérelo a un staff</li><hr color='green' />
